...
def _get_human_readable_property_name(
    ...
    return sync_overrides.get_human_readable_property_name(prop, rset_context)
...
class RendersetListerSwitchPage(bpy.types.Operator):
    ...
    def execute(self, context: bpy.types.Context):
        lister_props = utils.get_preferences(context).lister
        renderset_contexts = renderset_context_utils.get_all_renderset_contexts(context)
...
class RendersetLister(bpy.types.Operator):
    ...
    def draw(self, context: bpy.types.Context) -> None:
        ...
        for i, r_context in enumerate(renderset_contexts):
            row = col_flow.row()
            renderset_context.draw_color_and_name(context, row.row(), r_context)
    ...
    def invoke(self, context: bpy.types.Context, event: bpy.types.Event):
        ...
        active_renderset_context = renderset_context_utils.get_active_renderset_context(context)
