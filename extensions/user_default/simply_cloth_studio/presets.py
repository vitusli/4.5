...
def set_brush(self, context):
    ...
    elif(self.brushes == "POSE_TWIST"):
        bpy.ops.wm.tool_set_by_id(name="builtin_brush.Pose")
        bpy.data.brushes["Pose"].deform_target = 'CLOTH_SIM'
        bpy.data.brushes["Pose"].pose_deform_type = 'ROTATE_TWIST'
        bpy.context.object.brush_name = self.brushes

    elif(self.brushes == "POSE_SCALE"):
        bpy.ops.wm.tool_set_by_id(name="builtin_brush.Pose")
        bpy.data.brushes["Pose"].deform_target = 'CLOTH_SIM'
        bpy.data.brushes["Pose"].pose_deform_type = 'SCALE_TRANSLATE'
        bpy.context.object.brush_name = self.brushes

    elif(self.brushes == "POSE_STRETCH"):
        bpy.ops.wm.tool_set_by_id(name="builtin_brush.Pose")
        bpy.data.brushes["Pose"].deform_target = 'CLOTH_SIM'
        bpy.data.brushes["Pose"].pose_deform_type = 'SQUASH_STRETCH'
        bpy.context.object.brush_name = self.brushes

    elif(self.brushes == "BOUNDARY_BEND"):
        bpy.ops.wm.tool_set_by_id(name="builtin_brush.Boundary")
        bpy.data.brushes["Boundary"].deform_target = 'CLOTH_SIM'
        bpy.data.brushes["Boundary"].boundary_deform_type = 'BEND'
        bpy.context.object.brush_name = self.brushes

    elif(self.brushes == "BOUNDARY_INFLATE"):
        bpy.ops.wm.tool_set_by_id(name="builtin_brush.Boundary")
        bpy.data.brushes["Boundary"].deform_target = 'CLOTH_SIM'
        bpy.data.brushes["Boundary"].boundary_deform_type = 'INFLATE'
        bpy.context.object.brush_name = self.brushes

    elif(self.brushes == "BOUNDARY_GRAB"):
        bpy.ops.wm.tool_set_by_id(name="builtin_brush.Boundary")
        bpy.data.brushes["Boundary"].deform_target = 'CLOTH_SIM'
        bpy.data.brushes["Boundary"].boundary_deform_type = 'GRAB'
        bpy.context.object.brush_name = self.brushes

    elif(self.brushes == "BOUNDARY_TWIST"):
        bpy.ops.wm.tool_set_by_id(name="builtin_brush.Boundary")
        bpy.data.brushes["Boundary"].deform_target = 'CLOTH_SIM'
        bpy.data.brushes["Boundary"].boundary_deform_type = 'TWIST'
        bpy.context.object.brush_name = self.brushes

    elif(self.brushes == "BOUNDARY_SMOOTH"):
        bpy.ops.wm.tool_set_by_id(name="builtin_brush.Boundary")
        bpy.data.brushes["Boundary"].deform_target = 'GEOMETRY'
        bpy.data.brushes["Boundary"].boundary_deform_type = 'SMOOTH'
