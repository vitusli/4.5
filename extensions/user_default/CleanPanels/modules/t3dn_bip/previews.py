...
from .utils import can_load, load_file
...
class ImagePreviewCollection:
    ...
    def new_safe(self, name: str) -> ImagePreview:
        ...
        return self[name] if name in self else self.new(name)
    ...
    def load_safe(
        ...
        return self[name] if name in self else self.load(name, filepath, filetype)
