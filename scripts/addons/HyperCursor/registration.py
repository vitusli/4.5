...
classes = {'CORE': [('ui.UILists', [('HistoryCursorUIList', ''),
                    ...
                    ('ui.gizmos', [('Gizmo2DRing', '2d_ring'),
                                   ...
                                   ('GizmoGroupHyperCursorObjects', 'hyper_cursor_objects'),
                    ...
                    ('ui.operators.help', [('GetSupport', 'get_hypercursor_support')]),
           ...
           'ASSET': [('operators.asset', [('GetObjectAsset', 'get_object_asset'),
           ...
           'OBJECT': [('operators.object', [('Hype', 'hype'),
                                            ('Unhype', 'unhype'),
           ...
           'BEVEL': [('operators.bevel', [('HyperBevel', 'hyper_bevel'),
                                          ('HyperBevelOld', 'hyper_bevel_old'),
                                          ('AdjustHyperBevelSweep', 'adjust_hyper_bevel_sweep'),
                                          ('AdjustHyperBevelWidth', 'adjust_hyper_bevel_width'),
                                          ('AdjustHyperBevelExtend', 'adjust_hyper_bevel_extend'),
           ...
           'MODIFIER': [('operators.modifier', [('AddBoolean', 'add_boolean'),
                                                ('CollapseBooleans', 'collapse_booleans'),
                                                ('InitBooleanTranslateOnParent', 'init_boolean_translate_on_parent'),
                                                ...
                                                ('ManifoldBooleanConvert', 'manifold_boolean_convert')])],

           'DEBUG': [('operators.debug', [('HyperCursorDebug', 'hypercursor_debug')])],
           }
...
keys = {'HYPERCURSOR': (*get_box_select_keymaps(),
                        ...
                        ("machin3.cycle_cursor_history", {"type": 'WHEELUPMOUSE', "value": 'PRESS', "alt": True}, {"active": False}),
                        ("machin3.cycle_cursor_history", {"type": 'WHEELDOWNMOUSE', "value": 'PRESS', "alt": True}, {"active": False, "properties": [('backwards', False)]}),

                        ("machin3.focus_cursor", {"type": 'F', "value": 'PRESS', "shift": True}, {}),
                        ("machin3.focus_proximity", {"type": 'F', "value": 'PRESS', "shift": True, "alt": True}, {"properties": [('is_button_invocation', False), ('gizmoinvoke', False)]}),

                        ("machin3.transform_cursor", {"type": 'RIGHTMOUSE', "value": 'PRESS', "ctrl": True}, {"properties": [('mode', 'DRAG'), ('is_cursor_pie_invocation', False)]}),
                        ("machin3.cast_cursor", {"type": 'C', "value": 'PRESS', "shift": True}, {"properties": [('is_button_invocation', False)]}),
                        ...
                        ("machin3.add_boolean", {"type": 'B', "value": 'PRESS'}, {"properties": [('is_button_invocation', False)]}),
                        ...
                        ("machin3.hyper_modifier", {"type": 'W', "alt": True, "value": 'PRESS'}, {"properties": [('is_gizmo_invocation', False), ('is_button_invocation', False), ('mode', 'PICK')]}),
                        ("machin3.hyper_modifier", {"type": 'W', "shift": True, "alt":True, "value": 'PRESS'}, {"properties": [('is_gizmo_invocation', False), ('is_button_invocation', False), ('mode', 'ADD')]}),
                        ...
                        ("machin3.snap_rotate", {"type": 'E', "value": 'PRESS'}, {"properties": [('is_button_invocation', False)]}),
        ...
        'CUT': [{'keymap': 'Object Mode', 'idname': 'machin3.hyper_cut', 'type': 'X', 'value': 'PRESS', 'ctrl': True, 'active': False, 'properties': []}],

        'BEVEL': [{'keymap': 'Object Mode', 'idname': 'machin3.hyper_bevel', 'type': 'B', 'value': 'PRESS', 'ctrl': True, 'active': False, 'properties': []},
                  {'keymap': 'Object Mode', 'idname': 'machin3.pick_hyper_bevel', 'type': 'B', 'value': 'PRESS', 'alt': True, 'active': False, 'properties': []}],

        'BEND': [{'keymap': 'Object Mode', 'idname': 'machin3.hyper_bend', 'type': 'B', 'value': 'PRESS', 'shift': True, 'active': False, 'properties': []}],

        'OBJECT': [{'keymap': 'Object Mode', 'idname': 'machin3.pick_object_tree', 'type': 'Q', 'value': 'PRESS', 'alt': True, 'active': False, 'properties': []}],
