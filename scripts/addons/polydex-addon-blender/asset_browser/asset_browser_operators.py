...
from ..build import BUILD_OPTION_BOB


if BUILD_OPTION_BOB:
    BOB_OT_update_asset_browser = POLIIGON_OT_update_asset_browser
    BOB_OT_cancel_asset_browser_sync = POLIIGON_OT_cancel_asset_browser_sync
    BOB_OT_asset_browser_import = POLIIGON_OT_asset_browser_import
    BOB_OT_asset_browser_quick_menu = POLIIGON_OT_asset_browser_quick_menu
    BOB_OT_asset_browser_reprocess = POLIIGON_OT_asset_browser_reprocess
    BOB_OT_sync_client = POLIIGON_OT_sync_client

    classes = (
        BOB_OT_update_asset_browser,
        BOB_OT_cancel_asset_browser_sync,
        BOB_OT_asset_browser_import,
        BOB_OT_asset_browser_quick_menu,
        BOB_OT_asset_browser_reprocess,
        BOB_OT_sync_client
    )
else:
    classes = (
