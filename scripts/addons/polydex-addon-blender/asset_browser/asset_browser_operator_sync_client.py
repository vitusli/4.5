...
class POLIIGON_OT_sync_client(Operator):
    bl_idname = f"{PREFIX_OP}.asset_browser_sync_client"
    ...
    def _process_texture(
        ...
        try:
            op_base = get_op_base()
            result = op_base.poliigon_material(
