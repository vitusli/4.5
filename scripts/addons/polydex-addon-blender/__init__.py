...
bl_info = {
    ...
    "blender": (4, 2, 0),
    "location": "3D View",
    "description": "Browse and import assets detected in the Polydex application",
    "doc_url": "https://www.poliigon.com/polydex",
    "tracker_url": "https://help.poliigon.com/",
    "category": "3D View > Sidebar > Polydex",
}
...
def unregister():
    ...
    if toolbox.addon_bob is not None:
        toolbox.shutdown_addon(toolbox.addon_bob)
    if bpy.app.version >= (3, 0):
