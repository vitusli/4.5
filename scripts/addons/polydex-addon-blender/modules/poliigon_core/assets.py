...
class ModelType(IntEnum):
    ...
    MAX = 3
    C4D = 4
    OBJ = 5  # Polydex extension
    USD = 6  # Polydex extension
    STL = 7  # Polydex extension
    GLTF = 8  # Polydex extension
    SKP = 8  # Polydex extension
...
class AssetData:
    ...
    def update(self, asset_data_new, purge_maps: bool = False) -> None:
        ...
        if self.get_type_data() is None:
            print(f"No data type on {self}")
        else:
