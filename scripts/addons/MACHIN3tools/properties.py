...
class ObjectsCollection(bpy.types.PropertyGroup):
    name: StringProperty()
...
class HistoryEpochCollection(bpy.types.PropertyGroup):
    ...
    objects: CollectionProperty(type=ObjectsCollection)
    unmirrored: CollectionProperty(type=ObjectsCollection)
    unarrayed: CollectionProperty(type=ObjectsCollection)
