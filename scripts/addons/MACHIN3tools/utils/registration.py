...
def get_pie_menus():
    ...
    classlists, keylists, count = get_smart_pie(classlists, keylists, count)
...
def get_smart_pie(classlists=[], keylists=[], count=0):
    if get_prefs().activate_smart_pie:
        classlists.append(classesdict["SMART_PIE"])
        keylists.append(keysdict["SMART_PIE"])
        count += 1
