...
def adjust_bevel_shader(context, debug=False):
    ...
    for obj in visible_objs:
        ...
        if m3.use_bevel_shader:
            ...
            if M3.get_addon("DECALmachine") and obj.DM.decaltype == 'PANEL' and obj.parent:
    ...
    for mat in visible_mats:
        ...
        if not bevel:
            ...
            if last_node:
                ...
                elif M3.get_addon("DECALmachine") and (mat.DM.isdecalmat or mat.DM.istrimsheetmat):
                ...
                if normal_inputs:
                    ...
                    bevel, global_radius = create_and_connect_bevel_shader_setup(mat, last_node, normal_inputs, math, math2, math3, global_radius, obj_toggle, obj_modulation, dim_modulation, debug=debug)
        ...
        if m3.use_bevel_shader:
            ...
            if mat == white_bevel:
                ...
                remove_bevel_shader_setup(mat, bevel, math, math2, math3, global_radius, obj_toggle, obj_modulation, dim_modulation, debug)

def create_and_connect_bevel_shader_setup(mat, last_node, normal_inputs, math=None, math2=None, math3=None, global_radius=None, obj_toggle=None, obj_modulation=None, dim_modulation=None, debug=False):
    from .. import MACHIN3toolsManager as M3
    ...
    if M3.get_addon("DECALmachine") and mat.DM.istrimsheetmat:
        y_dim += 200
...
def remove_bevel_shader_setup(mat, bevel=None, math=None, math2=None, math3=None, global_radius=None, obj_toggle=None, obj_modulation=None, dim_modulation=None, debug=False):
    tree = mat.node_tree
    ...
    if M3.get_addon("DECALmachine") and (mat.DM.isdecalmat or mat.DM.istrimsheetmat):

        DM = M3.addons["decalmachine"]['module']

        if mat.DM.isdecalmat and mat.DM.decaltype == 'PANEL':
            detail_normal = tree.nodes.get('Detail Normal')
            dg = DM.utils.material.get_decalgroup_from_decalmat(mat)
            ...
            tsg = DM.utils.material.get_trimsheetgroup_from_trimsheetmat(mat)
