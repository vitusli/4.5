...
import bmesh
from ... items import uv_axis_items, uv_axis_index_mapping, align_type_items
...
class AlignUV(bpy.types.Operator):
    ...
    def poll(cls, context):
        return context.mode == "EDIT_MESH" and context.space_data and context.space_data.type == 'IMAGE_EDITOR'

    def execute(self, context):
        self.uv_align(context, self.type, uv_axis_index_mapping[self.axis])
        return {'FINISHED'}
