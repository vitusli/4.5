...
class CallMACHIN3toolsPie(bpy.types.Operator):
    ...
    def invoke(self, context, event):
        ...
        if view.type == 'VIEW_3D':
            ...
            elif self.idname == 'smart_pie' and context.mode == 'EDIT_MESH':

                bpy.types.MACHIN3_MT_smart_pie.mouse_pos = (event.mouse_x, event.mouse_y)
                bpy.types.MACHIN3_MT_smart_pie.mouse_pos_region = (event.mouse_region_x, event.mouse_region_y)
